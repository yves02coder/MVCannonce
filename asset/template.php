        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="connexionVendeur" name="connexion"><b>CONNEXION</b></a>
             ...
             <!--   <form class="d-flex input-group w-auto m-2"  method="post"  >
                    <label for="rechercheCatReg"></label>
...
<link rel="stylesheet" href="../View/connexion.css">
<!--
...
<h1 class="text-center text-capitalize">Bienvenue</h1>
</body>
</html>
