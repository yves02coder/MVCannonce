...
<form action="" method="post">
    <div class="wrapper fadeInDown" id="connexion">
        <div id="formContent">
            <!-- Tabs Titles -->
            <h2 class="active"> Incription </h2>
            <h2 class="inactive underlineHover"><a href="accueil">retour</a></h2>

            <!-- Icon -->
            <div class="fadeIn first">
                <img src="https://i.pinimg.com/474x/4c/b8/f8/4cb8f83a2b77c1d2350a7b08d185e38f--hd-iphone--wallpapers-backgrounds-wallpapers.jpg" id="icon" alt="User Icon" />
            </div>
